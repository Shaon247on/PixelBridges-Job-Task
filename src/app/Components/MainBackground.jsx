...
const MainBackground = () => {
    return (
        ...
        <div className="relative z-0 ">
          <h1 className="text-[148.48px] font-Cheesburga text-center gradient-text fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-[200%] text-nowrap">welcome to alabay world</h1>
