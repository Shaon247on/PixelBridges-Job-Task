        ...
        <React.Fragment>
            <div className='w-full bg-guardian bg-no-repeat bg-cover bg-center bg-fixed scroll-off'>
                <div className='p-[20px] lg:p-[82px]'>
                    <div className='fixed'>
                        <h1 className='text-[38px] lg:text-[96px] font-Baron text-white'>ALABAY GUARDIAN</h1>
                        <p className='ext-[24px] lg:text-[48px] font-Baron text-[#A4A8FF]'>SHEPHERD OF THE STEPPES</p>
                    </div>

                    {/* scrolled section */}

                    <div className='mt-[100px] lg:mt-[251px] scroll-container scroll-container2'>
                        <div className='h-[500px] lg:h-[100vh] lg:pt-10 lg:pb-20 section pr-9'>
                            ...
                            <motion.button
                                ...
                                initial='initial'
                                whileInView="animate"
                                className='w-[80px] md:w-[100px] lg:w-[220px] h-[40px] lg:h-[66px] flex items-center justify-center md:justify-between rounded-full bg-[#A4A8FF] text-[14px] lg:text-[23px] font-Helvetica uppercase mt-4 lg:mt-10 mb-4 lg:mb-24 px-[8px] lg:px-[18px]'>
                            ...
                            <div>
                                ...
                                <motion.h1
                                    ...
                                    whileInView="animate"
                                    exit="exit"
                                    className='text-[18px] lg:text-[32px] font-Montserrat font-bold text-white mb-6'><span className='text-[#A4A8FF]'>Game</span> Preview</motion.h1>
                                <div
                                    className='flex items-center justify-start gap-5 mx-auto'>
                                    <Image src={img1} alt='image-1' className='w-auto h-[100px] md:h-[130px] lg:h-[277px] rounded-[23px] border-[2.5px] border-white autoplay1' />
                        ...
                        <div
                            ...
                            <motion.h1
                                ...
                                whileInView="animate"
                                exit="exit"
                                className='text-[18px] md:text-[24px] lg:text-[32px] font-Montserrat font-bold text-[#A4A8FF]'>FEATURES</motion.h1>
                            <motion.p
                                variants={slideInAnimationVariants}
                                initial='initial'
                                whileInView="animate"
                                ...
                                className='text-[10px] md:text-[13px] mt-5 lg:mt-0 lg:text-[22px] w-[300px] md:w-[750px] font-Montserrat text-white font-bold'>Explore a variety of landscapes, including <span className='text-[#A4A8FF]'>mountains</span>, <span className='text-[#A4A8FF]'>forests</span>, <span className='text-[#A4A8FF]'>deserts</span>, and <span className='text-[#A4A8FF]'>ancient ruins</span>. <br className='hidden md:inline'/> <br className='hidden lg:inline'/>

                                Use the Alabay's <span className='text-[#A4A8FF]'>abilities</span> to solve <span className='text-[#A4A8FF]'>puzzles</span> that involve moving objects, activating mechanisms, or finding hidden clues. <br className='hidden md:inline'/><br className='hidden lg:inline'/>
                            ...
                            <motion.ul
                                ...
                                <li className=' lg:w-auto'><span className='text-[#A4A8FF]'>Time Trials</span>: Compete in special timed challenges where the Alabai must navigate through complex mazes or
                                    complete puzzles within a time limit.</li>
                                <li className=' lg:w-auto'><span className='text-[#A4A8FF]'>Exploration Mastery</span>: A mode that rewards players for fully exploring every nook and cranny of the game's world,
                            ...
                            <div className='flex gap-5 lg:gap-[50px]'>
                                ...
                                <Link href='\'><button
                                    className='w-[80px] md:w-[100px] lg:w-[220px] h-[40px] lg:h-[66px] flex items-center justify-center rounded-full bg-transparent text-white border-[3px] text-[14px] lg:text-[23px] font-Helvetica uppercase mt-4 lg:mt-10 mb-4 lg:mb-24 px-[8px] lg:px-[18px]'>EXIT</button></Link>
                            </div>
